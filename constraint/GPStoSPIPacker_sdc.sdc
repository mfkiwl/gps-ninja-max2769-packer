...
create_clock -name {GPStoSPIPacker|SPI2_SCK} -period 20.000000 -waveform {0.000000 5.000000} SPI2_SCK
create_clock -name {GPStoSPIPacker|SPI3_SCK} -period 20.000000 -waveform {0.000000 5.000000} SPI3_SCK
